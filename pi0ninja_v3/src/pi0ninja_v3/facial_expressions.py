...
class AnimatedFaces:
    ...
    based on a unified design style.
    """
    ...
    def __init__(self, lcd: ST7789V):
        ...
        # Style guide based on reference image
    ...
    def _animate(self, duration_s, frame_logic):
    ...
    def _draw_happy_base(self, draw):
        ...
        # Eyebrows raised above the eyes
    ...
    def play_idle(self, duration_s=3):
        print("Playing: Idle")
        def logic(draw, t):
            blink_cycle = (t * 2) % 3
            if blink_cycle < 0.15:
        ...
        self._animate(duration_s, logic)
