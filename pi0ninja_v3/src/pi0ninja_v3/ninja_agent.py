...
class NinjaAgent:
    ...
    def _create_system_prompt(self) -> str:
        return f"""You are Ninja, a small robot. You will receive user commands as text. Respond naturally and conversationally. You can perform physical actions or search the web.
